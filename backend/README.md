...
## Project Structure
    ...
    ├── testapiautostoryboa_82471  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_82471`
...
2. Clone this repo and `cd testapiautostoryboa_82471`
